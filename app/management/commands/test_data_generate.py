    ...
    for name in names_list:
        for session in ['Game', 'Training']:
            for _ in range(3):
                ...
                distance_covered = np.random.randint(95, 110)
...
# Save to a CSV file
output_file_path_with_names = 'C:/Users/14391/PycharmProjects/django-login-and-register/random_athlete_data_with_names.csv'
